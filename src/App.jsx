  ...
  return(
    <div style={{color:TEXT,paddingBottom:60}}>
      ...
      {QUARTERS.map(q=>{
        ...
        return(
          <div key={q}>
            <div style={{marginTop:24,padding:"8px 12px",background:"#0a0a14",border:"1px solid #1e1e3a",borderRadius:6,marginBottom:4,fontSize:11,color:"#8888cc",fontFamily:MONO,display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:4}}>
